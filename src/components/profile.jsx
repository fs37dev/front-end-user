      ...
      <div className="lg:px-20 px-10 py-5">
        ...
        <div className="card card-side bg-gradient-to-r from-emerald-500 to-blue-500 shadow-xl transform hover:scale-105 transition-transform duration-300 mt-4">
          <div className="card-body text-center text-white">
            <img src={data.image ? data.image : person} alt="" className="w-20 lg:w-40 mx-auto mb-4 rounded-full" />
            <h2 className="text-xl font-extrabold mb-2">{data.name}</h2>
            <p className="mt-1 text-md opacity-80">{data.email}</p>
          </div>
        </div>
        <div className="mt-4">
