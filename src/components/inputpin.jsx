      ...
      <div className="card bg-base-100 py-20 sm:flex sm:flex-col sm:justify-center sm:items-center sm:mt-30">
        <div className="card-body shadow-xl">
          ...
          <div className="flex items-center justify-center gap-5 sm:gap-7">
            <div className="kode">
              <input type="text" className="input input-bordered w-10 sm:w-20 text-center text-sm sm:text-base" maxLength="1" inputMode="number" />
            </div>
            <div className="kode">
              <input type="text" className="input input-bordered w-10 sm:w-20 text-center text-sm sm:text-base" maxLength="1" inputMode="number" />
            </div>
      ...
      <dialog id="my_modal_1" className="modal">
        <div className="modal-box">
          ...
          <p className="py-2 text-sm text-center">
            Reservasi anda berhasil. Anda akan menerima pemberitahuan dan dokter yang Anda pilih akan menghubungi Anda.
          </p>
          <div className="modal-action flex flex-col justify-center item-center">
            <form method="dialog">
              <button className="btn bg-emerald-500 hover:bg-emerald-700 w-full rounded-full text-white" onClick={() => navigate(`/reservations/${params.id}`)}>
                View Appointment
              </button>
            </form>
          </div>
